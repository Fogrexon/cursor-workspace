...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vs(e,t,n){let r=new Float32Array(is),i=new W(0,1,0);return new ba({name:`SphericalGaussianBlur`,defines:{n:is,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:xs(),fragmentShader:`
...
void main() {
  ...
  `;let t=e.querySelector(`#game`),n=e.querySelector(`#overlay`),r=e.querySelector(`#overlay-title`),i=e.querySelector(`#overlay-text`),a=e.querySelector(`#overlay-btn`),o=e.querySelector(`#speed`),s=e.querySelector(`#altitude`),c=e.querySelector(`#rings`),l=e.querySelector(`#status`),u=await Yd(t,{setStatus(e){l.textContent=e},setSpeed(e){o.textContent=e},setAltitude(e){s.textContent=e},setRings(e){c.textContent=e},showOverlay(e,t,o){r.textContent=e,i.textContent=t,a.textContent=o,n.hidden=!1},hideOverlay(){n.hidden=!0}}),d=()=>u.start();return a.addEventListener(`click`,d),()=>{a.removeEventListener(`click`,d),u.dispose()}}Xd(document.querySelector(`#app`));