...
`;function n(e){let t=e.replace(/^\uFEFF/,``);if(!t.startsWith(`---
`)&&!t.startsWith(`---\r
`))return{meta:{},body:e,hasFrontmatter:!1};let n=t.indexOf(`
---`,4);if(n===-1)return{meta:{},body:e,hasFrontmatter:!1};let i=t.slice(4,n).replace(/^\r/,``),a=t.slice(n+4).replace(/^(?:\r?\n)+/,``);return{meta:r(i),body:a,hasFrontmatter:!0}}function r(e){let t={},n=e.split(/\r?\n/),r=0;for(;r<n.length;){let e=n[r];if(!e.trim()||e.trimStart().startsWith(`#`)){r+=1;continue}let a=/^([A-Za-z][\w-]*)\s*:\s*(.*)$/.exec(e);if(!a){r+=1;continue}let o=a[1],s=a[2].trim();if(o===`tags`){if(s===``||s===`|`||s===`>`){let e=[];for(r+=1;r<n.length;){let t=/^\s*-\s+(.+)$/.exec(n[r]);if(!t)break;e.push(i(t[1].trim())),r+=1}t.tags=e;continue}if(s.startsWith(`[`)&&s.endsWith(`]`)){t.tags=s.slice(1,-1).split(`,`).map(e=>i(e.trim())).filter(Boolean),r+=1;continue}}let c=i(s);o===`title`?t.title=c:o===`summary`?t.summary=c:o===`date`?t.date=c:o===`category`?t.category=c:o===`status`?t.status=c:o===`audience`?t.audience=c:o===`lang`&&(t.lang=c),r+=1}return t}function i(e){return e.startsWith(`"`)&&e.endsWith(`"`)||e.startsWith(`'`)&&e.endsWith(`'`)?e.slice(1,-1):e}var a=`/reports/`;function o(e){let t=e.replaceAll(`\\`,`/`),n=t.lastIndexOf(a);return n===-1?null:t.slice(n+9)}function s(e){return e.endsWith(`.md`)?(e.split(`/`).pop()?.toLowerCase()??``)!==`readme.md`:!1}function c(e){return e.replace(/\.md$/i,``)}function l(e){return(e.split(`/`)[0]??``)||`other`}function u(e,t){let{body:r}=n(e),i=r.split(/\r?\n/);for(let e of i){let t=/^(#{1,6})\s+(.+?)\s*$/.exec(e);if(t)return t[2].replace(/\s+#+\s*$/,``).trim()}return(t.split(`/`).pop()??t).replace(/[-_]/g,` `)}function d(e,t=160){let{body:r}=n(e),i=r.split(/\r?\n/),a=[],o=!1;for(let e of i){let n=e.trim();if(n.startsWith("```")){o=!o;continue}if(!o){if(!n){if(a.length)break;continue}if(!(n.startsWith(`#`)||n.startsWith(`|`)||n.startsWith(`-`)||n.startsWith(`*`)||n.startsWith(`>`)||n===`---`||n===`***`)&&(a.push(n.replace(/[*_`[\]]/g,``)),a.join(` `).length>=t))break}}let s=a.join(` `).replace(/\s+/g,` `).trim();return s?s.length<=t?s:`${s.slice(0,t-1).trimEnd()}…`:``}function ee(e,t){let{meta:r,body:i}=n(e);if(r.date&&/^\d{4}-\d{2}-\d{2}$/.test(r.date))return r.date;let a=/\|\s*調査日\s*\|\s*(\d{4}-\d{2}-\d{2})\s*\|/.exec(i);if(a)return a[1];let o=/(?:調査日|日付|date)\s*[:：]\s*(\d{4}-\d{2}-\d{2})/i.exec(i);return o?o[1]:/(\d{4}-\d{2}-\d{2})/.exec(t)?.[1]??``}function f(e){let t=[];for(let[r,i]of Object.entries(e)){let e=o(r);if(!e||!s(e))continue;let{meta:a,body:f}=n(i),p=c(e),te=(a.tags??[]).map(e=>e.trim()).filter(Boolean);t.push({id:p,path:e,category:a.category?.trim()||l(e),title:a.title?.trim()||u(i,p),summary:a.summary?.trim()||d(i),date:ee(i,e),tags:te,status:a.status?.trim()||``,audience:a.audience?.trim()||``,markdown:f})}return t.sort((e,t)=>e.date===t.date?e.id.localeCompare(t.id):t.date.localeCompare(e.date))}function p(e){return[...new Set(e.map(e=>e.category))].sort((e,t)=>e.localeCompare(t))}function te(e,t,n){let r=t.trim().toLowerCase(),i=r.startsWith(`tag:`)?r.slice(4).trim():``;return e.filter(e=>n!==`all`&&e.category!==n?!1:r?i?e.tags.some(e=>e.toLowerCase()===i):[e.title,e.summary,e.path,e.id,e.audience,e.status,e.category,...e.tags].join(`
`).toLowerCase().includes(r):!0)}function m(e,t){return e.find(e=>e.id===t)}var ne=f(Object.assign({"../../../../reports/README.md":e,"../../../../reports/deep-research/2026-07-23-llm-agent-execution-harness.md":t}));function re(e){let t=(e.startsWith(`#`)?e.slice(1):e).replace(/^\/+/,``);if(!t)return{view:`list`,query:``,category:`all`};let[n,r=``]=t.split(`?`),i=new URLSearchParams(r);if(n===``||n===`list`){let e=(i.get(`category`)??`all`).trim()||`all`;return{view:`list`,query:i.get(`q`)??``,category:e}}if(n.startsWith(`r/`)){let e=decodeURIComponent(n.slice(2));if(e)return{view:`report`,id:e}}return{view:`list`,query:``,category:`all`}}function h(e){if(e.view===`report`)return`#/r/${encodeURIComponent(e.id)}`;let t=new URLSearchParams;e.query&&t.set(`q`,e.query),e.category!==`all`&&t.set(`category`,e.category);let n=t.toString();return n?`#/list?${n}`:`#/list`}function g(e){return e.replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`)}var _={all:`すべて`,"deep-research":`Deep research`,notes:`Notes`};function v(e){return _[e]??e}function ie(e){let t=[`all`,...e.categories].map(t=>`<button type="button" class="chip${t===e.category?` is-active`:``}" data-category="${g(t)}">${g(v(t))}</button>`).join(``),n=e.reports.map(e=>{let t=h({view:`report`,id:e.id}),n=e.date?`<time datetime="${g(e.date)}">${g(e.date)}</time>`:``,r=e.tags.map(e=>`<span class="tag tag--soft">${g(e)}</span>`).join(``),i=e.status?`<span class="tag">${g(e.status)}</span>`:``;return`
        <a class="report-card" href="${t}">
          <div class="report-card__meta">
            <span class="tag">${g(v(e.category))}</span>
            ${i}
            ${n}
          </div>
          <h2 class="report-card__title">${g(e.title)}</h2>
          <p class="report-card__summary">${g(e.summary||`（要約なし）`)}</p>
          <div class="report-card__tags">${r}</div>
          <p class="report-card__path"><code>${g(e.path)}</code></p>
        </a>`}).join(``);return`
    <section class="list">
      <div class="toolbar">
        <label class="search">
  ...
  `}function ae(e,t){let n=e.trim().toLowerCase().replace(/[^\w\u00C0-\u024F\u3040-\u30FF\u3400-\u9FFF\uAC00-\uD7AF\s-]/g,``).replace(/\s+/g,`-`).replace(/-+/g,`-`).replace(/^-|-$/g,``)||`section`,r=(t.get(n)??0)+1;return t.set(n,r),r===1?n:`${n}-${r}`}function oe(e){let t=[],n=new Map,r=!1;for(let i of e.split(/\r?\n/)){let e=i.trimEnd();if(e.trimStart().startsWith("```")){r=!r;continue}if(r)continue;let a=/^(#{1,3})\s+(.+?)\s*$/.exec(e);if(!a)continue;let o=a[1].length,s=a[2].replace(/\s+#+\s*$/,``).trim(),c=ae(s,n);t.push({id:c,text:s,level:o})}return t}function se(e,t){(t==null||t>e.length)&&(t=e.length);for(var n=0,r=Array(t);n<t;n++)r[n]=e[n];return r}function ce(e){if(Array.isArray(e))return e}function le(e,t){var n=e==null?null:typeof Symbol<`u`&&e[Symbol.iterator]||e[`@@iterator`];if(n!=null){var r,i,a,o,s=[],c=!0,l=!1;try{if(a=(n=n.call(e)).next,t!==0)for(;!(c=(r=a.call(n)).done)&&(s.push(r.value),s.length!==t);c=!0);}catch(e){l=!0,i=e}finally{try{if(!c&&n.return!=null&&(o=n.return(),Object(o)!==o))return}finally{if(l)throw i}}return s}}function ue(){throw TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function de(e,t){return ce(e)||le(e,t)||fe(e,t)||ue()}function fe(e,t){if(e){if(typeof e==`string`)return se(e,t);var n={}.toString.call(e).slice(8,-1);return n===`Object`&&e.constructor&&(n=e.constructor.name),n===`Map`||n===`Set`?Array.from(e):n===`Arguments`||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?se(e,t):void 0}}var pe=Object.entries,me=Object.setPrototypeOf,he=Object.isFrozen,ge=Object.getPrototypeOf,_e=Object.getOwnPropertyDescriptor,y=Object.freeze,b=Object.seal,ve=Object.create,x=typeof Reflect<`u`&&Reflect,ye=x.apply,be=x.construct;y||=function(e){return e},b||=function(e){return e},ye||=function(e,t){var n=[...arguments].slice(2);return e.apply(t,n)},be||=function(e){return new e(...[...arguments].slice(1))};var xe=w(Array.prototype.forEach),Se=w(Array.prototype.lastIndexOf),Ce=w(Array.prototype.pop),we=w(Array.prototype.push),Te=w(Array.prototype.splice),Ee=Array.isArray,De=w(String.prototype.toLowerCase),Oe=w(String.prototype.toString),ke=w(String.prototype.match),Ae=w(String.prototype.replace),je=w(String.prototype.indexOf),Me=w(String.prototype.trim),Ne=w(Number.prototype.toString),Pe=w(Boolean.prototype.toString),Fe=typeof BigInt>`u`?null:w(BigInt.prototype.toString),Ie=typeof Symbol>`u`?null:w(Symbol.prototype.toString),S=w(Object.prototype.hasOwnProperty),Le=w(Object.prototype.toString),C=w(RegExp.prototype.test),Re=ze(TypeError);function w(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);var n=[...arguments].slice(1);return ye(e,t,n)}}function ze(e){return function(){return be(e,[...arguments])}}function T(e,t){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:De;if(me&&me(e,null),!Ee(t))return e;let r=t.length;for(;r--;){let i=t[r];if(typeof i==`string`){let e=n(i);e!==i&&(he(t)||(t[r]=e),i=e)}e[i]=!0}return e}function E(e){for(let t=0;t<e.length;t++)S(e,t)||(e[t]=null);return e}function D(e){let t=ve(null);for(let r of pe(e)){var n=de(r,2);let i=n[0],a=n[1];S(e,i)&&(Ee(a)?t[i]=E(a):a&&typeof a==`object`&&a.constructor===Object?t[i]=D(a):t[i]=a)}return t}function Be(e){switch(typeof e){case`string`:return e;case`number`:return Ne(e);case`boolean`:return Pe(e);case`bigint`:return Fe?Fe(e):`0`;case`symbol`:return Ie?Ie(e):`Symbol()`;case`undefined`:return Le(e);case`function`:case`object`:{if(e===null)return Le(e);let t=e,n=O(t,`toString`);if(typeof n==`function`){let e=n(t);return typeof e==`string`?e:Le(e)}return Le(e)}default:return Le(e)}}function O(e,t){for(;e!==null;){let n=_e(e,t);if(n){if(n.get)return w(n.get);if(typeof n.value==`function`)return w(n.value)}e=ge(e)}function n(){return null}return n}function Ve(e){try{return C(e,``),!0}catch{return!1}}var He=y(`a.abbr.acronym.address.area.article.aside.audio.b.bdi.bdo.big.blink.blockquote.body.br.button.canvas.caption.center.cite.code.col.colgroup.content.data.datalist.dd.decorator.del.details.dfn.dialog.dir.div.dl.dt.element.em.fieldset.figcaption.figure.font.footer.form.h1.h2.h3.h4.h5.h6.head.header.hgroup.hr.html.i.img.input.ins.kbd.label.legend.li.main.map.mark.marquee.menu.menuitem.meter.nav.nobr.ol.optgroup.option.output.p.picture.pre.progress.q.rp.rt.ruby.s.samp.search.section.select.shadow.slot.small.source.spacer.span.strike.strong.style.sub.summary.sup.table.tbody.td.template.textarea.tfoot.th.thead.time.tr.track.tt.u.ul.var.video.wbr`.split(`.`)),Ue=y(`svg.a.altglyph.altglyphdef.altglyphitem.animatecolor.animatemotion.animatetransform.circle.clippath.defs.desc.ellipse.enterkeyhint.exportparts.filter.font.g.glyph.glyphref.hkern.image.inputmode.line.lineargradient.marker.mask.metadata.mpath.part.path.pattern.polygon.polyline.radialgradient.rect.stop.style.switch.symbol.text.textpath.title.tref.tspan.view.vkern`.split(`.`)),We=y([`feBlend`,`feColorMatrix`,`feComponentTransfer`,`feComposite`,`feConvolveMatrix`,`feDiffuseLighting`,`feDisplacementMap`,`feDistantLight`,`feDropShadow`,`feFlood`,`feFuncA`,`feFuncB`,`feFuncG`,`feFuncR`,`feGaussianBlur`,`feImage`,`feMerge`,`feMergeNode`,`feMorphology`,`feOffset`,`fePointLight`,`feSpecularLighting`,`feSpotLight`,`feTile`,`feTurbulence`]),Ge=y([`animate`,`color-profile`,`cursor`,`discard`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`foreignobject`,`hatch`,`hatchpath`,`mesh`,`meshgradient`,`meshpatch`,`meshrow`,`missing-glyph`,`script`,`set`,`solidcolor`,`unknown`,`use`]),Ke=y(`math.menclose.merror.mfenced.mfrac.mglyph.mi.mlabeledtr.mmultiscripts.mn.mo.mover.mpadded.mphantom.mroot.mrow.ms.mspace.msqrt.mstyle.msub.msup.msubsup.mtable.mtd.mtext.mtr.munder.munderover.mprescripts`.split(`.`)),qe=y([`maction`,`maligngroup`,`malignmark`,`mlongdiv`,`mscarries`,`mscarry`,`msgroup`,`mstack`,`msline`,`msrow`,`semantics`,`annotation`,`annotation-xml`,`mprescripts`,`none`]),Je=y([`#text`]),Ye=y(`accept.action.align.alt.autocapitalize.autocomplete.autopictureinpicture.autoplay.background.bgcolor.border.capture.cellpadding.cellspacing.checked.cite.class.clear.color.cols.colspan.command.commandfor.controls.controlslist.coords.crossorigin.datetime.decoding.default.dir.disabled.disablepictureinpicture.disableremoteplayback.download.draggable.enctype.enterkeyhint.exportparts.face.for.headers.height.hidden.high.href.hreflang.id.inert.inputmode.integrity.ismap.kind.label.lang.list.loading.loop.low.max.maxlength.media.method.min.minlength.multiple.muted.name.nonce.noshade.novalidate.nowrap.open.optimum.part.pattern.placeholder.playsinline.popover.popovertarget.popovertargetaction.poster.preload.pubdate.radiogroup.readonly.rel.required.rev.reversed.role.rows.rowspan.spellcheck.scope.selected.shape.size.sizes.slot.span.srclang.start.src.srcset.step.style.summary.tabindex.title.translate.type.usemap.valign.value.width.wrap.xmlns`.split(`.`)),Xe=y(`accent-height.accumulate.additive.alignment-baseline.amplitude.ascent.attributename.attributetype.azimuth.basefrequency.baseline-shift.begin.bias.by.class.clip.clippathunits.clip-path.clip-rule.color.color-interpolation.color-interpolation-filters.color-profile.color-rendering.cx.cy.d.dx.dy.diffuseconstant.direction.display.divisor.dominant-baseline.dur.edgemode.elevation.end.exponent.fill.fill-opacity.fill-rule.filter.filterunits.flood-color.flood-opacity.font-family.font-size.font-size-adjust.font-stretch.font-style.font-variant.font-weight.fx.fy.g1.g2.glyph-name.glyphref.gradientunits.gradienttransform.height.href.id.image-rendering.in.in2.intercept.k.k1.k2.k3.k4.kerning.keypoints.keysplines.keytimes.lang.lengthadjust.letter-spacing.kernelmatrix.kernelunitlength.lighting-color.local.marker-end.marker-mid.marker-start.markerheight.markerunits.markerwidth.maskcontentunits.maskunits.max.mask.mask-type.media.method.mode.min.name.numoctaves.offset.operator.opacity.order.orient.orientation.origin.overflow.paint-order.path.pathlength.patterncontentunits.patterntransform.patternunits.points.preservealpha.preserveaspectratio.primitiveunits.r.rx.ry.radius.refx.refy.repeatcount.repeatdur.restart.result.rotate.scale.seed.shape-rendering.slope.specularconstant.specularexponent.spreadmethod.startoffset.stddeviation.stitchtiles.stop-color.stop-opacity.stroke-dasharray.stroke-dashoffset.stroke-linecap.stroke-linejoin.stroke-miterlimit.stroke-opacity.stroke.stroke-width.style.surfacescale.systemlanguage.tabindex.tablevalues.targetx.targety.transform.transform-origin.text-anchor.text-decoration.text-orientation.text-rendering.textlength.type.u1.u2.unicode.values.viewbox.visibility.version.vert-adv-y.vert-origin-x.vert-origin-y.width.word-spacing.wrap.writing-mode.xchannelselector.ychannelselector.x.x1.x2.xmlns.y.y1.y2.z.zoomandpan`.split(`.`)),Ze=y(`accent.accentunder.align.bevelled.close.columnalign.columnlines.columnspacing.columnspan.denomalign.depth.dir.display.displaystyle.encoding.fence.frame.height.href.id.largeop.length.linethickness.lquote.lspace.mathbackground.mathcolor.mathsize.mathvariant.maxsize.minsize.movablelimits.notation.numalign.open.rowalign.rowlines.rowspacing.rowspan.rspace.rquote.scriptlevel.scriptminsize.scriptsizemultiplier.selection.separator.separators.stretchy.subscriptshift.supscriptshift.symmetric.voffset.width.xmlns`.split(`.`)),Qe=y([`xlink:href`,`xml:id`,`xlink:title`,`xml:space`,`xmlns:xlink`]),$e=b(/{{[\w\W]*|^[\w\W]*}}/g),et=b(/<%[\w\W]*|^[\w\W]*%>/g),tt=b(/\${[\w\W]*/g),nt=b(/^data-[\-\w.\u00B7-\uFFFF]+$/),rt=b(/^aria-[\-\w]+$/),it=b(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),at=b(/^(?:\w+script|data):/i),ot=b(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),st=b(/^html$/i),ct=b(/^[a-z][.\w]*(-[.\w]+)+$/i),lt=b(/<[/\w!]/g),ut=b(/<[/\w]/g),dt=b(/<\/no(script|embed|frames)/i),ft=b(/\/>/i),k={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,processingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},pt=function(){return typeof window>`u`?null:window},mt=function(e,t){if(typeof e!=`object`||typeof e.createPolicy!=`function`)return null;let n=null,r=`data-tt-policy-suffix`;t&&t.hasAttribute(r)&&(n=t.getAttribute(r));let i=`dompurify`+(n?`#`+n:``);try{return e.createPolicy(i,{createHTML(e){return e},createScriptURL(e){return e}})}catch{return console.warn(`TrustedTypes policy `+i+` could not be created.`),null}},ht=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}},gt=function(e,t,n,r){return S(e,t)&&Ee(e[t])?T(r.base?D(r.base):{},e[t],r.transform):n};function _t(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:pt(),t=e=>_t(e);if(t.version=`3.4.12`,t.removed=[],!e||!e.document||e.document.nodeType!==k.document||!e.Element)return t.isSupported=!1,t;let n=e.document,r=n,i=r.currentScript;e.DocumentFragment;let a=e.HTMLTemplateElement,o=e.Node,s=e.Element,c=e.NodeFilter;e.NamedNodeMap===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;let l=e.DOMParser,u=e.trustedTypes,d=s.prototype,ee=O(d,`cloneNode`),f=O(d,`remove`),p=O(d,`nextSibling`),te=O(d,`childNodes`),m=O(d,`parentNode`),ne=O(d,`shadowRoot`),re=O(d,`attributes`),h=o&&o.prototype?O(o.prototype,`nodeType`):null,g=o&&o.prototype?O(o.prototype,`nodeName`):null;if(typeof a==`function`){let e=n.createElement(`template`);e.content&&e.content.ownerDocument&&(n=e.content.ownerDocument)}let _,v=``,ie,ae=!1,oe=0,se=function(){if(oe>0)throw Re(`A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.`)},ce=function(e){se(),oe++;try{return _.createHTML(e)}finally{oe--}},le=function(e){se(),oe++;try{return _.createScriptURL(e)}finally{oe--}},ue=function(){return ae||=(ie=mt(u,i),!0),ie},de=n,fe=de.implementation,me=de.createNodeIterator,he=de.createDocumentFragment,ge=de.getElementsByTagName,_e=r.importNode,x=ht();t.isSupported=typeof pe==`function`&&typeof m==`function`&&fe&&fe.createHTMLDocument!==void 0;let ye=$e,be=et,Ne=tt,Pe=nt,Fe=rt,Ie=at,Le=ot,w=ct,ze=it,E=null,vt=T({},[...He,...Ue,...We,...Ke,...Je]),A=null,j=T({},[...Ye,...Xe,...Ze,...Qe]),M=Object.seal(ve(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),N=null,yt=null,P=Object.seal(ve(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}})),bt=!0,F=!0,xt=!1,St=!0,I=!1,L=!0,Ct=!1,wt=!1,Tt=null,Et=null,Dt=!1,R=!1,Ot=!1,kt=!1,At=!0,jt=!1,Mt=`user-content-`,Nt=!0,Pt=!1,z={},B=null,Ft=T({},`annotation-xml.audio.colgroup.desc.foreignobject.head.iframe.math.mi.mn.mo.ms.mtext.noembed.noframes.noscript.plaintext.script.selectedcontent.style.svg.template.thead.title.video.xmp`.split(`.`)),It=null,Lt=T({},[`audio`,`video`,`img`,`source`,`image`,`track`]),Rt=null,zt=T({},[`alt`,`class`,`for`,`id`,`label`,`name`,`pattern`,`placeholder`,`role`,`summary`,`title`,`value`,`style`,`xmlns`]),Bt=`http://www.w3.org/1998/Math/MathML`,Vt=`http://www.w3.org/2000/svg`,V=`http://www.w3.org/1999/xhtml`,Ht=V,H=!1,Ut=null,Wt=T({},[Bt,Vt,V],Oe),Gt=y([`mi`,`mo`,`mn`,`ms`,`mtext`]),Kt=T({},Gt),qt=y([`annotation-xml`]),Jt=T({},qt),Yt=T({},[`title`,`style`,`font`,`a`,`script`]),Xt=null,Zt=[`application/xhtml+xml`,`text/html`],U=null,W=null,Qt=n.createElement(`form`),$t=function(e){return e instanceof RegExp||e instanceof Function},en=function(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(W&&W===e)return;(!e||typeof e!=`object`)&&(e={}),e=D(e),Xt=Zt.indexOf(e.PARSER_MEDIA_TYPE)===-1?`text/html`:e.PARSER_MEDIA_TYPE,U=Xt===`application/xhtml+xml`?Oe:De,E=gt(e,`ALLOWED_TAGS`,vt,{transform:U}),A=gt(e,`ALLOWED_ATTR`,j,{transform:U}),Ut=gt(e,`ALLOWED_NAMESPACES`,Wt,{transform:Oe}),Rt=gt(e,`ADD_URI_SAFE_ATTR`,zt,{transform:U,base:zt}),It=gt(e,`ADD_DATA_URI_TAGS`,Lt,{transform:U,base:Lt}),B=gt(e,`FORBID_CONTENTS`,Ft,{transform:U}),N=gt(e,`FORBID_TAGS`,D({}),{transform:U}),yt=gt(e,`FORBID_ATTR`,D({}),{transform:U}),z=S(e,`USE_PROFILES`)?e.USE_PROFILES&&typeof e.USE_PROFILES==`object`?D(e.USE_PROFILES):e.USE_PROFILES:!1,bt=e.ALLOW_ARIA_ATTR!==!1,F=e.ALLOW_DATA_ATTR!==!1,xt=e.ALLOW_UNKNOWN_PROTOCOLS||!1,St=e.ALLOW_SELF_CLOSE_IN_ATTR!==!1,I=e.SAFE_FOR_TEMPLATES||!1,L=e.SAFE_FOR_XML!==!1,Ct=e.WHOLE_DOCUMENT||!1,R=e.RETURN_DOM||!1,Ot=e.RETURN_DOM_FRAGMENT||!1,kt=e.RETURN_TRUSTED_TYPE||!1,Dt=e.FORCE_BODY||!1,At=e.SANITIZE_DOM!==!1,jt=e.SANITIZE_NAMED_PROPS||!1,Nt=e.KEEP_CONTENT!==!1,Pt=e.IN_PLACE||!1,ze=Ve(e.ALLOWED_URI_REGEXP)?e.ALLOWED_URI_REGEXP:it,Ht=typeof e.NAMESPACE==`string`?e.NAMESPACE:V,Kt=S(e,`MATHML_TEXT_INTEGRATION_POINTS`)&&e.MATHML_TEXT_INTEGRATION_POINTS&&typeof e.MATHML_TEXT_INTEGRATION_POINTS==`object`?D(e.MATHML_TEXT_INTEGRATION_POINTS):T({},Gt),Jt=S(e,`HTML_INTEGRATION_POINTS`)&&e.HTML_INTEGRATION_POINTS&&typeof e.HTML_INTEGRATION_POINTS==`object`?D(e.HTML_INTEGRATION_POINTS):T({},qt);let t=S(e,`CUSTOM_ELEMENT_HANDLING`)&&e.CUSTOM_ELEMENT_HANDLING&&typeof e.CUSTOM_ELEMENT_HANDLING==`object`?D(e.CUSTOM_ELEMENT_HANDLING):ve(null);if(M=ve(null),S(t,`tagNameCheck`)&&$t(t.tagNameCheck)&&(M.tagNameCheck=t.tagNameCheck),S(t,`attributeNameCheck`)&&$t(t.attributeNameCheck)&&(M.attributeNameCheck=t.attributeNameCheck),S(t,`allowCustomizedBuiltInElements`)&&typeof t.allowCustomizedBuiltInElements==`boolean`&&(M.allowCustomizedBuiltInElements=t.allowCustomizedBuiltInElements),b(M),I&&(F=!1),Ot&&(R=!0),z&&(E=T({},Je),A=ve(null),z.html===!0&&(T(E,He),T(A,Ye)),z.svg===!0&&(T(E,Ue),T(A,Xe),T(A,Qe)),z.svgFilters===!0&&(T(E,We),T(A,Xe),T(A,Qe)),z.mathMl===!0&&(T(E,Ke),T(A,Ze),T(A,Qe))),P.tagCheck=null,P.attributeCheck=null,S(e,`ADD_TAGS`)&&(typeof e.ADD_TAGS==`function`?P.tagCheck=e.ADD_TAGS:Ee(e.ADD_TAGS)&&(E===vt&&(E=D(E)),T(E,e.ADD_TAGS,U))),S(e,`ADD_ATTR`)&&(typeof e.ADD_ATTR==`function`?P.attributeCheck=e.ADD_ATTR:Ee(e.ADD_ATTR)&&(A===j&&(A=D(A)),T(A,e.ADD_ATTR,U))),S(e,`ADD_URI_SAFE_ATTR`)&&Ee(e.ADD_URI_SAFE_ATTR)&&T(Rt,e.ADD_URI_SAFE_ATTR,U),S(e,`FORBID_CONTENTS`)&&Ee(e.FORBID_CONTENTS)&&(B===Ft&&(B=D(B)),T(B,e.FORBID_CONTENTS,U)),S(e,`ADD_FORBID_CONTENTS`)&&Ee(e.ADD_FORBID_CONTENTS)&&(B===Ft&&(B=D(B)),T(B,e.ADD_FORBID_CONTENTS,U)),Nt&&(E[`#text`]=!0),Ct&&T(E,[`html`,`head`,`body`]),E.table&&(T(E,[`tbody`]),delete N.tbody),e.TRUSTED_TYPES_POLICY){if(typeof e.TRUSTED_TYPES_POLICY.createHTML!=`function`)throw Re(`TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.`);if(typeof e.TRUSTED_TYPES_POLICY.createScriptURL!=`function`)throw Re(`TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.`);let t=_;_=e.TRUSTED_TYPES_POLICY;try{v=ce(``)}catch(e){throw _=t,e}}else e.TRUSTED_TYPES_POLICY===null?(_=void 0,v=``):(_===void 0&&(_=ue()),_&&typeof v==`string`&&(v=ce(``)));y&&y(e),W=e},tn=T({},[...Ue,...We,...Ge]),nn=T({},[...Ke,...qe]),rn=function(e,t,n){return t.namespaceURI===V?e===`svg`:t.namespaceURI===Bt?e===`svg`&&(n===`annotation-xml`||Kt[n]):!!tn[e]},an=function(e,t,n){return t.namespaceURI===V?e===`math`:t.namespaceURI===Vt?e===`math`&&Jt[n]:!!nn[e]},on=function(e,t,n){return t.namespaceURI===Vt&&!Jt[n]||t.namespaceURI===Bt&&!Kt[n]?!1:!nn[e]&&(Yt[e]||!tn[e])},sn=function(e){let t=m(e);(!t||!t.tagName)&&(t={namespaceURI:Ht,tagName:`template`});let n=De(e.tagName),r=De(t.tagName);return Ut[e.namespaceURI]?e.namespaceURI===Vt?rn(n,t,r):e.namespaceURI===Bt?an(n,t,r):e.namespaceURI===V?on(n,t,r):!!(Xt===`application/xhtml+xml`&&Ut[e.namespaceURI]):!1},G=function(e){we(t.removed,{element:e});try{m(e).removeChild(e)}catch{if(f(e),!m(e))throw Re(`a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place`)}},cn=function(e){un(e);let t=te(e);if(t){let e=[];xe(t,t=>{we(e,t)}),xe(e,e=>{try{f(e)}catch{}})}let n=re(e);if(n)for(let t=n.length-1;t>=0;--t){let r=n[t],i=r&&r.name;if(typeof i==`string`)try{e.removeAttribute(i)}catch{}}},K=function(e,n){try{we(t.removed,{attribute:n.getAttributeNode(e),from:n})}catch{we(t.removed,{attribute:null,from:n})}if(n.removeAttribute(e),e===`is`)if(R||Ot)try{G(n)}catch{}else try{n.setAttribute(e,``)}catch{}},ln=function(e){let t=re(e);if(t)for(let n=t.length-1;n>=0;--n){let r=t[n],i=r&&r.name;if(!(typeof i!=`string`||A[U(i)]))try{e.removeAttribute(i)}catch{}}},un=function(e){let t=[e];for(;t.length>0;){let e=t.pop();(h?h(e):e.nodeType)===k.element&&ln(e);let n=te(e);if(n)for(let e=n.length-1;e>=0;--e)t.push(n[e])}},dn=function(e){if(!L)return;let t=[e];for(;t.length>0;){let e=t.pop(),n=h?h(e):e.nodeType;if(n===k.processingInstruction||n===k.comment&&C(ut,e.data)){try{f(e)}catch{}continue}if(n===k.element){let t=e,n=U(g?g(e):e.nodeName);try{t.hasAttribute&&t.hasAttribute(`patchsrc`)&&t.removeAttribute(`patchsrc`),t.hasAttribute&&t.hasAttribute(`for`)&&n!==`label`&&n!==`output`&&t.removeAttribute(`for`)}catch{}}let r=te(e);if(r)for(let e=r.length-1;e>=0;--e)t.push(r[e])}},fn=function(e){let t=null,r=null;if(Dt)e=`<remove></remove>`+e;else{let t=ke(e,/^[\r\n\t ]+/);r=t&&t[0]}Xt===`application/xhtml+xml`&&Ht===V&&(e=`<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>`+e+`</body></html>`);let i=_?ce(e):e;if(Ht===V)try{t=new l().parseFromString(i,Xt)}catch{}if(!t||!t.documentElement){t=fe.createDocument(Ht,`template`,null);try{t.documentElement.innerHTML=H?v:i}catch{}}let a=t.body||t.documentElement;return e&&r&&a.insertBefore(n.createTextNode(r),a.childNodes[0]||null),Ht===V?ge.call(t,Ct?`html`:`body`)[0]:Ct?t.documentElement:a},pn=function(e){return me.call(e.ownerDocument||e,e,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT|c.SHOW_PROCESSING_INSTRUCTION|c.SHOW_CDATA_SECTION,null)},mn=function(e){return e=Ae(e,ye,` `),e=Ae(e,be,` `),e=Ae(e,Ne,` `),e},hn=function(e){e.normalize();let t=me.call(e.ownerDocument||e,e,c.SHOW_TEXT|c.SHOW_COMMENT|c.SHOW_CDATA_SECTION|c.SHOW_PROCESSING_INSTRUCTION,null),n=t.nextNode();for(;n;)n.data=mn(n.data),n=t.nextNode();let r=e.querySelectorAll?.call(e,`template`);r&&xe(r,e=>{q(e.content)&&hn(e.content)})},gn=function(e){let t=g?g(e):null;return typeof t!=`string`||U(t)!==`form`?!1:typeof e.nodeName!=`string`||typeof e.textContent!=`string`||typeof e.removeChild!=`function`||e.attributes!==re(e)||typeof e.removeAttribute!=`function`||typeof e.setAttribute!=`function`||typeof e.namespaceURI!=`string`||typeof e.insertBefore!=`function`||typeof e.hasChildNodes!=`function`||e.nodeType!==h(e)||e.childNodes!==te(e)},q=function(e){if(!h||typeof e!=`object`||!e)return!1;try{return h(e)===k.documentFragment}catch{return!1}},_n=function(e){if(!h||typeof e!=`object`||!e)return!1;try{return typeof h(e)==`number`}catch{return!1}};function J(e,n,r){e.length!==0&&xe(e,e=>{e.call(t,n,r,W)})}let Y=function(e,t){return!!(L&&e.hasChildNodes()&&!_n(e.firstElementChild)&&C(lt,e.textContent)&&C(lt,e.innerHTML)||L&&e.namespaceURI===V&&t===`style`&&_n(e.firstElementChild)||e.nodeType===k.processingInstruction||L&&e.nodeType===k.comment&&C(ut,e.data))},vn=function(e,t){if(!N[t]&&xn(t)&&(M.tagNameCheck instanceof RegExp&&C(M.tagNameCheck,t)||M.tagNameCheck instanceof Function&&M.tagNameCheck(t)))return!1;if(Nt&&!B[t]){let t=m(e),n=te(e);if(n&&t){let r=n.length;for(let i=r-1;i>=0;--i){let r=Pt?n[i]:ee(n[i],!0);t.insertBefore(r,p(e))}}}return G(e),!0},yn=function(e,n){if(J(x.beforeSanitizeElements,e,null),e!==n&&m(e)===null)return!0;if(gn(e))return G(e),!0;let r=U(g?g(e):e.nodeName);if(J(x.uponSanitizeElement,e,{tagName:r,allowedTags:E}),e!==n&&m(e)===null)return!0;if(Y(e,r))return G(e),!0;if(N[r]||!(P.tagCheck instanceof Function&&P.tagCheck(r))&&!E[r]){let t=vn(e,r);return t===!1&&J(x.afterSanitizeElements,e,null),t}if((h?h(e):e.nodeType)===k.element&&!sn(e)||(r===`noscript`||r===`noembed`||r===`noframes`)&&C(dt,e.innerHTML))return G(e),!0;if(I&&e.nodeType===k.text){let n=mn(e.textContent);e.textContent!==n&&(we(t.removed,{element:e.cloneNode()}),e.textContent=n)}return J(x.afterSanitizeElements,e,null),!1},X=function(e,t,r){if(yt[t]||L&&t===`patchsrc`||L&&t===`for`&&e!==`label`&&e!==`output`||At&&(t===`id`||t===`name`)&&(r in n||r in Qt))return!1;let i=A[t]||P.attributeCheck instanceof Function&&P.attributeCheck(t,e);if(!(F&&C(Pe,t))&&!(bt&&C(Fe,t))){if(!i){if(!(xn(e)&&(M.tagNameCheck instanceof RegExp&&C(M.tagNameCheck,e)||M.tagNameCheck instanceof Function&&M.tagNameCheck(e))&&(M.attributeNameCheck instanceof RegExp&&C(M.attributeNameCheck,t)||M.attributeNameCheck instanceof Function&&M.attributeNameCheck(t,e))||t===`is`&&M.allowCustomizedBuiltInElements&&(M.tagNameCheck instanceof RegExp&&C(M.tagNameCheck,r)||M.tagNameCheck instanceof Function&&M.tagNameCheck(r))))return!1}else if(!Rt[t]&&!C(ze,Ae(r,Le,``))&&!((t===`src`||t===`xlink:href`||t===`href`)&&e!==`script`&&je(r,`data:`)===0&&It[e])&&!(xt&&!C(Ie,Ae(r,Le,``)))&&r)return!1}return!0},bn=T({},[`annotation-xml`,`color-profile`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`missing-glyph`]),xn=function(e){return!bn[De(e)]&&C(w,e)},Sn=function(e,t,n,r){if(_&&typeof u==`object`&&typeof u.getAttributeType==`function`&&!n)switch(u.getAttributeType(e,t)){case`TrustedHTML`:return ce(r);case`TrustedScriptURL`:return le(r)}return r},Cn=function(e,n,r,i){try{r?e.setAttributeNS(r,n,i):e.setAttribute(n,i),gn(e)?G(e):Ce(t.removed)}catch{K(n,e)}},wn=function(e){J(x.beforeSanitizeAttributes,e,null);let t=e.attributes;if(!t||gn(e))return;let n={attrName:``,attrValue:``,keepAttr:!0,allowedAttributes:A,forceKeepAttr:void 0},r=t.length,i=U(e.nodeName);for(;r--;){let a=t[r],o=a.name,s=a.namespaceURI,c=a.value,l=U(o),u=c,d=o===`value`?u:Me(u);if(n.attrName=l,n.attrValue=d,n.keepAttr=!0,n.forceKeepAttr=void 0,J(x.uponSanitizeAttribute,e,n),d=n.attrValue,jt&&(l===`id`||l===`name`)&&je(d,Mt)!==0&&(K(o,e),d=Mt+d),L&&C(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,d)){K(o,e);continue}if(l===`attributename`&&ke(d,`href`)){K(o,e);continue}if(!n.forceKeepAttr){if(!n.keepAttr){K(o,e);continue}if(!St&&C(ft,d)){K(o,e);continue}if(I&&(d=mn(d)),!X(i,l,d)){K(o,e);continue}d=Sn(i,l,s,d),d!==u&&Cn(e,o,s,d)}}J(x.afterSanitizeAttributes,e,null)},Tn=function(e){let t=null,n=pn(e);for(J(x.beforeSanitizeShadowDOM,e,null);t=n.nextNode();)if(J(x.uponSanitizeShadowNode,t,null),yn(t,e),wn(t),q(t.content)&&Tn(t.content),(h?h(t):t.nodeType)===k.element){let e=ne(t);q(e)&&(Z(e),Tn(e))}J(x.afterSanitizeShadowDOM,e,null)},Z=function(e){let t=[{node:e,shadow:null}];for(;t.length>0;){let e=t.pop();if(e.shadow){Tn(e.shadow);continue}let n=e.node,r=(h?h(n):n.nodeType)===k.element,i=te(n);if(i)for(let e=i.length-1;e>=0;--e)t.push({node:i[e],shadow:null});if(r){let e=g?g(n):null;if(typeof e==`string`&&U(e)===`template`){let e=n.content;q(e)&&t.push({node:e,shadow:null})}}if(r){let e=ne(n);q(e)&&t.push({node:null,shadow:e},{node:e,shadow:null})}}};return t.sanitize=function(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},i=null,a=null,o=null,s=null;if(H=!e,H&&(e=`<!-->`),typeof e!=`string`&&!_n(e)&&(e=Be(e),typeof e!=`string`))throw Re(`dirty is not a string, aborting`);if(!t.isSupported)return e;wt?(E=Tt,A=Et):en(n),(x.uponSanitizeElement.length>0||x.uponSanitizeAttribute.length>0)&&(E=D(E)),x.uponSanitizeAttribute.length>0&&(A=D(A)),t.removed=[];let c=Pt&&typeof e!=`string`&&_n(e);if(c){dn(e);let t=g?g(e):e.nodeName;if(typeof t==`string`){let n=U(t);if(!E[n]||N[n])throw cn(e),Re(`root node is forbidden and cannot be sanitized in-place`)}if(gn(e))throw cn(e),Re(`root node is clobbered and cannot be sanitized in-place`);try{Z(e)}catch(t){throw cn(e),t}}else if(_n(e))i=fn(`<!---->`),a=i.ownerDocument.importNode(e,!0),a.nodeType===k.element&&a.nodeName===`BODY`||a.nodeName===`HTML`?i=a:i.appendChild(a),Z(a);else{if(!R&&!I&&!Ct&&e.indexOf(`<`)===-1)return _&&kt?ce(e):e;if(i=fn(e),!i)return R?null:kt?v:``}i&&Dt&&G(i.firstChild);let l=c?e:i,u=pn(l);try{for(;o=u.nextNode();)yn(o,l),wn(o),q(o.content)&&Tn(o.content)}catch(n){throw c&&(cn(e),xe(t.removed,e=>{e.element&&un(e.element)})),n}if(c)return xe(t.removed,e=>{e.element&&un(e.element)}),I&&hn(e),e;if(R){if(I&&hn(i),Ot)for(s=he.call(i.ownerDocument);i.firstChild;)s.appendChild(i.firstChild);else s=i;return(A.shadowroot||A.shadowrootmode)&&(s=_e.call(r,s,!0)),s}let d=Ct?i.outerHTML:i.innerHTML;return Ct&&E[`!doctype`]&&i.ownerDocument&&i.ownerDocument.doctype&&i.ownerDocument.doctype.name&&C(st,i.ownerDocument.doctype.name)&&(d=`<!DOCTYPE `+i.ownerDocument.doctype.name+`>
`+d),I&&(d=mn(d)),_&&kt?ce(d):d},t.setConfig=function(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};en(e),wt=!0,Tt=E,Et=A},t.clearConfig=function(){W=null,wt=!1,Tt=null,Et=null,_=ie,v=``},t.isValidAttribute=function(e,t,n){W||en({});let r=U(e),i=U(t);return X(r,i,n)},t.addHook=function(e,t){typeof t==`function`&&S(x,e)&&we(x[e],t)},t.removeHook=function(e,t){if(S(x,e)){if(t!==void 0){let n=Se(x[e],t);return n===-1?void 0:Te(x[e],n,1)[0]}return Ce(x[e])}},t.removeHooks=function(e){S(x,e)&&(x[e]=[])},t.removeAllHooks=function(){x=ht()},t}var vt=_t();function A(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var j=A();function M(e){j=e}var N={exec:()=>null};function yt(e){let t=[];return n=>{let r=Math.max(0,Math.min(3,n-1)),i=t[r];return i||(i=e(r),t[r]=i),i}}function P(e,t=``){let n=typeof e==`string`?e:e.source,r={replace:(e,t)=>{let i=typeof t==`string`?t:t.source;return i=i.replace(F.caret,`$1`),n=n.replace(e,i),r},getRegex:()=>new RegExp(n,t)};return r}var bt=((e=``)=>{try{return!!RegExp(`(?<=1)(?<!1)`+e)}catch{return!1}})(),F={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:yt(e=>RegExp(`^ {0,${e}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`)),hrRegex:yt(e=>RegExp(`^ {0,${e}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`)),fencesBeginRegex:yt(e=>RegExp(`^ {0,${e}}(?:\`\`\`|~~~)`)),headingBeginRegex:yt(e=>RegExp(`^ {0,${e}}#`)),htmlBeginRegex:yt(e=>RegExp(`^ {0,${e}}<(?:[a-z].*>|!--)`,`i`)),blockquoteBeginRegex:yt(e=>RegExp(`^ {0,${e}}>`))},xt=/^(?:[ \t]*(?:\n|$))+/,St=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,I=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,L=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Ct=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,wt=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,Tt=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Et=P(Tt).replace(/bull/g,wt).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}(?:\s|$)/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,``).getRegex(),Dt=P(Tt).replace(/bull/g,wt).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}(?:\s|$)/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),R=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table|[ \t]+\n)[^\n]+)*)/,Ot=/^[^\n]+/,kt=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,At=P(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace(`label`,kt).replace(`title`,/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),jt=P(/^(bull)([ \t][^\n]*?)?(?:\n|$)/).replace(/bull/g,wt).getRegex(),Mt=`address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul`,Nt=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Pt=P(`^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n*|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>[^\\n]*\\n*|$)|<![A-Z][\\s\\S]*?(?:>[^\\n]*\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>[^\\n]*\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))`,`i`).replace(`comment`,Nt).replace(`tag`,Mt).replace(`attribute`,/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),z=e=>P(R).replace(`hr`,L).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~~~)[^\\n]*\\n").replace(`list`,e).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,Mt).getRegex(),B=z(/ {0,3}(?:[*+-]|1[.)])[ \t]+[^ \t\n]/),Ft=z(/ {0,3}(?:[*+-]|\d{1,9}[.)])(?:[ \t]|\n|$)/),It={blockquote:P(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace(`paragraph`,Ft).getRegex(),code:St,def:At,fences:I,heading:Ct,hr:L,html:Pt,lheading:Et,list:jt,newline:xt,paragraph:B,table:N,text:Ot},Lt=P(`^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)`).replace(`hr`,L).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`blockquote`,` {0,3}>`).replace(`code`,`(?: {4}| {0,3}	)[^\\n]`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~~~)[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)])[ \\t]`).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,Mt).getRegex(),Rt={...It,lheading:Dt,table:Lt,paragraph:P(R).replace(`hr`,L).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`table`,Lt).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~~~)[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)])[ \\t]+[^ \\t\\n]`).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,Mt).getRegex()},zt={...It,html:P(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace(`comment`,Nt).replace(/tag/g,`(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b`).getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:N,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:P(R).replace(`hr`,L).replace(`heading`,` *#{1,6} *[^
]`).replace(`lheading`,Et).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`|fences`,``).replace(`|list`,``).replace(`|html`,``).replace(`|tag`,``).getRegex()},Bt=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Vt=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,V=/^( {2,}|\\)\n(?!\s*$)/,Ht=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,H=/[\p{P}\p{S}]/u,Ut=/[\s\p{P}\p{S}]/u,Wt=/[^\s\p{P}\p{S}]/u,Gt=P(/^((?![*_])punctSpace)/,`u`).replace(/punctSpace/g,Ut).getRegex(),Kt=/(?!~)[\p{P}\p{S}]/u,qt=/(?!~)[\s\p{P}\p{S}]/u,Jt=/(?:[^\s\p{P}\p{S}]|~)/u,Yt=P(/link|precode-code|html/,`g`).replace(`link`,/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace(`precode-`,bt?"(?<!`)()":"(^^|[^`])").replace(`code`,/(?<b>`+)[^`]+\k<b>(?!`)/).replace(`html`,/<(?! )[^<>]*?>/).getRegex(),Xt=/^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,Zt=P(Xt,`u`).replace(/punct/g,H).getRegex(),U=P(Xt,`u`).replace(/punct/g,Kt).getRegex(),W=`^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)`,Qt=P(W,`gu`).replace(/notPunctSpace/g,Wt).replace(/punctSpace/g,Ut).replace(/punct/g,H).getRegex(),$t=P(W,`gu`).replace(/notPunctSpace/g,Jt).replace(/punctSpace/g,qt).replace(/punct/g,Kt).getRegex(),en=P(`^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)`,`gu`).replace(/notPunctSpace/g,Wt).replace(/punctSpace/g,Ut).replace(/punct/g,H).getRegex(),tn=P(/^~~?(?:((?!~)punct)|[^\s~])/,`u`).replace(/punct/g,H).getRegex(),nn=P(`^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)`,`gu`).replace(/notPunctSpace/g,Wt).replace(/punctSpace/g,Ut).replace(/punct/g,H).getRegex(),rn=P(/\\(punct)/,`gu`).replace(/punct/g,H).getRegex(),an=P(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace(`scheme`,/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace(`email`,/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),on=P(Nt).replace(`(?:-->|$)`,`-->`).getRegex(),sn=P(`^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>`).replace(`comment`,on).replace(`attribute`,/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),G=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+(?!`)[^`]*?`+(?!`)|``+(?=\])|[^\[\]\\`])*?/,cn=P(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace(`label`,G).replace(`href`,/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]+|(?=\))/).replace(`title`,/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),K=P(/^!?\[(label)\]\[(ref)\]/).replace(`label`,G).replace(`ref`,kt).getRegex(),ln=P(/^!?\[(ref)\](?:\[\])?/).replace(`ref`,kt).getRegex(),un=P(`reflink|nolink(?!\\()`,`g`).replace(`reflink`,K).replace(`nolink`,ln).getRegex(),dn=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,fn={_backpedal:N,anyPunctuation:rn,autolink:an,blockSkip:Yt,br:V,code:Vt,del:N,delLDelim:N,delRDelim:N,emStrongLDelim:Zt,emStrongRDelimAst:Qt,emStrongRDelimUnd:en,escape:Bt,link:cn,nolink:ln,punctuation:Gt,reflink:K,reflinkSearch:un,tag:sn,text:Ht,url:N},pn={...fn,link:P(/^!?\[(label)\]\((.*?)\)/).replace(`label`,G).getRegex(),reflink:P(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace(`label`,G).getRegex()},mn={...fn,emStrongRDelimAst:$t,emStrongLDelim:U,delLDelim:tn,delRDelim:nn,url:P(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace(`protocol`,dn).replace(`email`,/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:P(/^(`+|~+|[^`~])(?:(?=[`~])|(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace(`protocol`,dn).getRegex()},hn={...mn,br:P(V).replace(`{2,}`,`*`).getRegex(),text:P(mn.text).replace(`\\b_`,`\\b_| {2,}\\n`).replace(/\{2,\}/g,`*`).getRegex()},gn={normal:It,gfm:Rt,pedantic:zt},q={normal:fn,gfm:mn,breaks:hn,pedantic:pn},_n={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},J=e=>_n[e];function Y(e,t){if(t){if(F.escapeTest.test(e))return e.replace(F.escapeReplace,J)}else if(F.escapeTestNoEncode.test(e))return e.replace(F.escapeReplaceNoEncode,J);return e}function vn(e){try{e=encodeURI(e).replace(F.percentDecode,`%`)}catch{return null}return e}function yn(e,t){let n=e.replace(F.findPipe,(e,t,n)=>{let r=!1,i=t;for(;--i>=0&&n[i]===`\\`;)r=!r;return r?`|`:` |`}).split(F.splitPipe),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push(``);for(;r<n.length;r++)n[r]=n[r].trim().replace(F.slashPipe,`|`);return n}function X(e,t,n){let r=e.length;if(r===0)return``;let i=0;for(;i<r;){let a=e.charAt(r-i-1);if(a===t&&!n)i++;else if(a!==t&&n)i++;else break}return e.slice(0,r-i)}function bn(e){let t=e.split(`
`),n=t.length-1;for(;n>=0&&F.blankLine.test(t[n]);)n--;return t.length-n<=2?e:t.slice(0,n+1).join(`
`)}function xn(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let r=0;r<e.length;r++)if(e[r]===`\\`)r++;else if(e[r]===t[0])n++;else if(e[r]===t[1]&&(n--,n<0))return r;return n>0?-2:-1}function Sn(e,t=0){let n=t,r=``;for(let t of e)if(t===`	`){let e=4-n%4;r+=` `.repeat(e),n+=e}else r+=t,n++;return r}function Cn(e,t,n,r,i){let a=t.href,o=t.title||null,s=e[1].replace(i.other.outputLinkReplace,`$1`);r.state.inLink=!0;let c={type:e[0].charAt(0)===`!`?`image`:`link`,raw:n,href:a,title:o,text:s,tokens:r.inlineTokens(s)};return r.state.inLink=!1,c}function wn(e,t,n){let r=e.match(n.other.indentCodeCompensation);if(r===null)return t;let i=r[1];return t.split(`
`).map(e=>{let t=e.match(n.other.beginningSpace);if(t===null)return e;let[r]=t;return r.length>=i.length?e.slice(i.length):e}).join(`
`)}var Tn=class{options;rules;lexer;constructor(e){this.options=e||j}space(e){let t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:`space`,raw:t[0]}}code(e){let t=this.rules.block.code.exec(e);if(t){let e=this.options.pedantic?t[0]:bn(t[0]);return{type:`code`,raw:e,codeBlockStyle:`indented`,text:e.replace(this.rules.other.codeRemoveIndent,``)}}}fences(e){let t=this.rules.block.fences.exec(e);if(t){let e=t[0],n=wn(e,t[3]||``,this.rules);return{type:`code`,raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,`$1`):t[2],text:n}}}heading(e){let t=this.rules.block.heading.exec(e);if(t){let e=t[2].trim();if(this.rules.other.endingHash.test(e)){let t=X(e,`#`);(this.options.pedantic||!t||this.rules.other.endingSpaceChar.test(t))&&(e=t.trim())}return{type:`heading`,raw:X(t[0],`
`),depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(e){let t=this.rules.block.hr.exec(e);if(t)return{type:`hr`,raw:X(t[0],`
...
`+l}u=!l.trim(),r+=f+`
`,e=e.substring(f.length+1),c=p.slice(d)}}i.loose||(o?i.loose=!0:this.rules.other.doubleBlankLine.test(r)&&(o=!0)),i.items.push({type:`list_item`,raw:r,task:!!this.options.gfm&&this.rules.other.listIsTask.test(s),loose:!1,text:s,tokens:[]}),i.raw+=r}let s=i.items.at(-1);if(s)s.raw=s.raw.trimEnd(),s.text=s.text.trimEnd();else return;i.raw=i.raw.trimEnd();for(let e of i.items){this.lexer.state.top=!1,e.tokens=this.lexer.blockTokens(e.text,[]);let t=e.tokens[0];if(e.task&&(t?.type===`text`||t?.type===`paragraph`)){e.text=e.text.replace(this.rules.other.listReplaceTask,``),t.raw=t.raw.replace(this.rules.other.listReplaceTask,``),t.text=t.text.replace(this.rules.other.listReplaceTask,``);for(let e=this.lexer.inlineQueue.length-1;e>=0;e--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[e].src)){this.lexer.inlineQueue[e].src=this.lexer.inlineQueue[e].src.replace(this.rules.other.listReplaceTask,``);break}let n=this.rules.other.listTaskCheckbox.exec(e.raw);if(n){let t={type:`checkbox`,raw:n[0]+` `,checked:n[0]!==`[ ]`};e.checked=t.checked,i.loose?e.tokens[0]&&[`paragraph`,`text`].includes(e.tokens[0].type)&&`tokens`in e.tokens[0]&&e.tokens[0].tokens?(e.tokens[0].raw=t.raw+e.tokens[0].raw,e.tokens[0].text=t.raw+e.tokens[0].text,e.tokens[0].tokens.unshift(t)):e.tokens.unshift({type:`paragraph`,raw:t.raw,text:t.raw,tokens:[t]}):e.tokens.unshift(t)}}else e.task&&=!1;if(!i.loose){let t=e.tokens.filter(e=>e.type===`space`);i.loose=t.length>0&&t.some(e=>this.rules.other.anyLine.test(e.raw))}}if(i.loose)for(let e of i.items){e.loose=!0;for(let t of e.tokens)t.type===`text`&&(t.type=`paragraph`)}return i}}html(e){let t=this.rules.block.html.exec(e);if(t){let e=bn(t[0]);return{type:`html`,block:!0,raw:e,pre:t[1]===`pre`||t[1]===`script`||t[1]===`style`,text:e}}}def(e){let t=this.rules.block.def.exec(e);if(t){let e=t[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal,` `),n=t[2]?t[2].replace(this.rules.other.hrefBrackets,`$1`).replace(this.rules.inline.anyPunctuation,`$1`):``,r=t[3]?t[3].substring(1,t[3].length-1).replace(this.rules.inline.anyPunctuation,`$1`):t[3];return{type:`def`,tag:e,raw:X(t[0],`
`),href:n,title:r}}}table(e){let t=this.rules.block.table.exec(e);if(!t||!this.rules.other.tableDelimiter.test(t[2]))return;let n=yn(t[1]),r=t[2].replace(this.rules.other.tableAlignChars,``).split(`|`),i=t[3]?.trim()?t[3].replace(this.rules.other.tableRowBlankLine,``).split(`
`):[],a={type:`table`,raw:X(t[0],`
`),header:[],align:[],rows:[]};if(n.length===r.length){for(let e of r)this.rules.other.tableAlignRight.test(e)?a.align.push(`right`):this.rules.other.tableAlignCenter.test(e)?a.align.push(`center`):this.rules.other.tableAlignLeft.test(e)?a.align.push(`left`):a.align.push(null);for(let e=0;e<n.length;e++)a.header.push({text:n[e],tokens:this.lexer.inline(n[e]),header:!0,align:a.align[e]});for(let e of i)a.rows.push(yn(e,a.header.length).map((e,t)=>({text:e,tokens:this.lexer.inline(e),header:!1,align:a.align[t]})));return a}}lheading(e){let t=this.rules.block.lheading.exec(e);if(t){let e=t[1].trim();return{type:`heading`,raw:X(t[0],`
`),depth:t[2].charAt(0)===`=`?1:2,text:e,tokens:this.lexer.inline(e)}}}paragraph(e){let t=this.rules.block.paragraph.exec(e);if(t){let e=t[1].charAt(t[1].length-1)===`
`?t[1].slice(0,-1):t[1];return{type:`paragraph`,raw:t[0],text:e,tokens:this.lexer.inline(e)}}}text(e){let t=this.rules.block.text.exec(e);if(t)return{type:`text`,raw:t[0],text:t[0],tokens:this.lexer.inline(t[0])}}escape(e){let t=this.rules.inline.escape.exec(e);if(t)return{type:`escape`,raw:t[0],text:t[1]}}tag(e){let t=this.rules.inline.tag.exec(e);if(t)return!this.lexer.state.inLink&&this.rules.other.startATag.test(t[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&this.rules.other.endATag.test(t[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&this.rules.other.startPreScriptTag.test(t[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&this.rules.other.endPreScriptTag.test(t[0])&&(this.lexer.state.inRawBlock=!1),{type:`html`,raw:t[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:t[0]}}link(e){let t=this.rules.inline.link.exec(e);if(t){let e=t[2].trim();if(!this.options.pedantic&&this.rules.other.startAngleBracket.test(e)){if(!this.rules.other.endAngleBracket.test(e))return;let t=X(e.slice(0,-1),`\\`);if((e.length-t.length)%2==0)return}else{let e=xn(t[2],`()`);if(e===-2)return;if(e>-1){let n=(t[0].indexOf(`!`)===0?5:4)+t[1].length+e;t[2]=t[2].substring(0,e),t[0]=t[0].substring(0,n).trim(),t[3]=``}}let n=t[2],r=``;if(this.options.pedantic){let e=this.rules.other.pedanticHrefTitle.exec(n);e&&(n=e[1],r=e[3])}else r=t[3]?t[3].slice(1,-1):``;return n=n.trim(),this.rules.other.startAngleBracket.test(n)&&(n=this.options.pedantic&&!this.rules.other.endAngleBracket.test(e)?n.slice(1):n.slice(1,-1)),Cn(t,{href:n&&n.replace(this.rules.inline.anyPunctuation,`$1`),title:r&&r.replace(this.rules.inline.anyPunctuation,`$1`)},t[0],this.lexer,this.rules)}}reflink(e,t){let n;if((n=this.rules.inline.reflink.exec(e))||(n=this.rules.inline.nolink.exec(e))){let e=t[(n[2]||n[1]).replace(this.rules.other.multipleSpaceGlobal,` `).toLowerCase()];if(!e){let e=n[0].charAt(0);return{type:`text`,raw:e,text:e}}return Cn(n,e,n[0],this.lexer,this.rules)}}emStrong(e,t,n=``){let r=this.rules.inline.emStrongLDelim.exec(e);if(!(!r||!r[1]&&!r[2]&&!r[3]&&!r[4]||r[4]&&n.match(this.rules.other.unicodeAlphaNumeric))&&(!(r[1]||r[3])||!n||this.rules.inline.punctuation.exec(n))){let n=[...r[0]].length-1,i,a,o=n,s=0,c=r[0][0]===`*`?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(c.lastIndex=0,t=t.slice(-1*e.length+n);(r=c.exec(t))!==null;){if(i=r[1]||r[2]||r[3]||r[4]||r[5]||r[6],!i)continue;if(a=[...i].length,r[3]||r[4]){o+=a;continue}else if((r[5]||r[6])&&n%3&&!((n+a)%3)){s+=a;continue}if(o-=a,o>0)continue;a=Math.min(a,a+o+s);let t=[...r[0]][0].length,c=e.slice(0,n+r.index+t+a);if(Math.min(n,a)%2){let e=c.slice(1,-1);return{type:`em`,raw:c,text:e,tokens:this.lexer.inlineTokens(e)}}let l=c.slice(2,-2);return{type:`strong`,raw:c,text:l,tokens:this.lexer.inlineTokens(l)}}}}codespan(e){let t=this.rules.inline.code.exec(e);if(t){let e=t[2].replace(this.rules.other.newLineCharGlobal,` `),n=this.rules.other.nonSpaceChar.test(e),r=this.rules.other.startingSpaceChar.test(e)&&this.rules.other.endingSpaceChar.test(e);return n&&r&&(e=e.substring(1,e.length-1)),{type:`codespan`,raw:t[0],text:e}}}br(e){let t=this.rules.inline.br.exec(e);if(t)return{type:`br`,raw:t[0]}}del(e,t,n=``){let r=this.rules.inline.delLDelim.exec(e);if(r&&(!r[1]||!n||this.rules.inline.punctuation.exec(n))){let n=[...r[0]].length-1,i,a,o=n,s=this.rules.inline.delRDelim;for(s.lastIndex=0,t=t.slice(-1*e.length+n);(r=s.exec(t))!==null;){if(i=r[1]||r[2]||r[3]||r[4]||r[5]||r[6],!i||(a=[...i].length,a!==n))continue;if(r[3]||r[4]){o+=a;continue}if(o-=a,o>0)continue;a=Math.min(a,a+o);let t=[...r[0]][0].length,s=e.slice(0,n+r.index+t+a),c=s.slice(n,-n);return{type:`del`,raw:s,text:c,tokens:this.lexer.inlineTokens(c)}}}}autolink(e){let t=this.rules.inline.autolink.exec(e);if(t){let e,n;return t[2]===`@`?(e=t[1],n=`mailto:`+e):(e=t[1],n=e),{type:`link`,raw:t[0],text:e,href:n,tokens:[{type:`text`,raw:e,text:e}]}}}url(e){let t;if(t=this.rules.inline.url.exec(e)){let e,n;if(t[2]===`@`)e=t[0],n=`mailto:`+e;else{let r;do r=t[0],t[0]=this.rules.inline._backpedal.exec(t[0])?.[0]??``;while(r!==t[0]);e=t[0],n=t[1]===`www.`?`http://`+t[0]:t[0]}return{type:`link`,raw:t[0],text:e,href:n,tokens:[{type:`text`,raw:e,text:e}]}}}inlineText(e){let t=this.rules.inline.text.exec(e);if(t){let e=this.lexer.state.inRawBlock;return{type:`text`,raw:t[0],text:t[0],escaped:e}}}},Z=class e{tokens;options;state;inlineQueue;tokenizer;constructor(e){this.tokens=[],this.tokens.links=Object.create(null),this.options=e||j,this.options.tokenizer=this.options.tokenizer||new Tn,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let t={other:F,block:gn.normal,inline:q.normal};this.options.pedantic?(t.block=gn.pedantic,t.inline=q.pedantic):this.options.gfm&&(t.block=gn.gfm,this.options.breaks?t.inline=q.breaks:t.inline=q.gfm),this.tokenizer.rules=t}static get rules(){return{block:gn,inline:q}}static lex(t,n){return new e(n).lex(t)}static lexInline(t,n){return new e(n).inlineTokens(t)}lex(e){e=e.replace(F.carriageReturn,`
...
`}strong({tokens:e}){return`<strong>${this.parser.parseInline(e)}</strong>`}em({tokens:e}){return`<em>${this.parser.parseInline(e)}</em>`}codespan({text:e}){return`<code>${Y(e,!0)}</code>`}br(e){return`<br>`}del({tokens:e}){return`<del>${this.parser.parseInline(e)}</del>`}link({href:e,title:t,tokens:n}){let r=this.parser.parseInline(n),i=vn(e);if(i===null)return r;e=i;let a=`<a href="`+e+`"`;return t&&(a+=` title="`+Y(t)+`"`),a+=`>`+r+`</a>`,a}image({href:e,title:t,text:n,tokens:r}){r&&(n=this.parser.parseInline(r,this.parser.textRenderer));let i=vn(e);if(i===null)return Y(n);e=i;let a=`<img src="${e}" alt="${Y(n)}"`;return t&&(a+=` title="${Y(t)}"`),a+=`>`,a}text(e){return`tokens`in e&&e.tokens?this.parser.parseInline(e.tokens):`escaped`in e&&e.escaped?e.text:Y(e.text)}},Dn=class{strong({text:e}){return e}em({text:e}){return e}codespan({text:e}){return e}del({text:e}){return e}html({text:e}){return e}text({text:e}){return e}link({text:e}){return``+e}image({text:e}){return``+e}br(){return``}checkbox({raw:e}){return e}},Q=class e{options;renderer;textRenderer;constructor(e){this.options=e||j,this.options.renderer=this.options.renderer||new En,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new Dn}static parse(t,n){return new e(n).parse(t)}static parseInline(t,n){return new e(n).parseInline(t)}parse(e){this.renderer.parser=this;let t=``;for(let n=0;n<e.length;n++){let r=e[n];if(this.options.extensions?.renderers?.[r.type]){let e=r,n=this.options.extensions.renderers[e.type].call({parser:this},e);if(n!==!1||![`space`,`hr`,`heading`,`code`,`table`,`blockquote`,`list`,`html`,`def`,`paragraph`,`text`].includes(e.type)){t+=n||``;continue}}let i=r;switch(i.type){case`space`:t+=this.renderer.space(i);break;case`hr`:t+=this.renderer.hr(i);break;case`heading`:t+=this.renderer.heading(i);break;case`code`:t+=this.renderer.code(i);break;case`table`:t+=this.renderer.table(i);break;case`blockquote`:t+=this.renderer.blockquote(i);break;case`list`:t+=this.renderer.list(i);break;case`checkbox`:t+=this.renderer.checkbox(i);break;case`html`:t+=this.renderer.html(i);break;case`def`:t+=this.renderer.def(i);break;case`paragraph`:t+=this.renderer.paragraph(i);break;case`text`:t+=this.renderer.text(i);break;default:{let e=`Token with "`+i.type+`" type was not found.`;if(this.options.silent)return console.error(e),``;throw Error(e)}}}return t}parseInline(e,t=this.renderer){this.renderer.parser=this;let n=``;for(let r=0;r<e.length;r++){let i=e[r];if(this.options.extensions?.renderers?.[i.type]){let e=this.options.extensions.renderers[i.type].call({parser:this},i);if(e!==!1||![`escape`,`html`,`link`,`image`,`strong`,`em`,`codespan`,`br`,`del`,`text`].includes(i.type)){n+=e||``;continue}}let a=i;switch(a.type){case`escape`:n+=t.text(a);break;case`html`:n+=t.html(a);break;case`link`:n+=t.link(a);break;case`image`:n+=t.image(a);break;case`checkbox`:n+=t.checkbox(a);break;case`strong`:n+=t.strong(a);break;case`em`:n+=t.em(a);break;case`codespan`:n+=t.codespan(a);break;case`br`:n+=t.br(a);break;case`del`:n+=t.del(a);break;case`text`:n+=t.text(a);break;default:{let e=`Token with "`+a.type+`" type was not found.`;if(this.options.silent)return console.error(e),``;throw Error(e)}}}return n}},On=class{options;block;constructor(e){this.options=e||j}static passThroughHooks=new Set([`preprocess`,`postprocess`,`processAllTokens`,`emStrongMask`]);static passThroughHooksRespectAsync=new Set([`preprocess`,`postprocess`,`processAllTokens`]);preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}emStrongMask(e){return e}provideLexer(e=this.block){return e?Z.lex:Z.lexInline}provideParser(e=this.block){return e?Q.parse:Q.parseInline}},kn=class{defaults=A();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=Q;Renderer=En;TextRenderer=Dn;Lexer=Z;Tokenizer=Tn;Hooks=On;constructor(...e){this.use(...e)}walkTokens(e,t){let n=[];for(let r of e)switch(n=n.concat(t.call(this,r)),r.type){case`table`:{let e=r;for(let r of e.header)n=n.concat(this.walkTokens(r.tokens,t));for(let r of e.rows)for(let e of r)n=n.concat(this.walkTokens(e.tokens,t));break}case`list`:{let e=r;n=n.concat(this.walkTokens(e.items,t));break}default:{let e=r;this.defaults.extensions?.childTokens?.[e.type]?this.defaults.extensions.childTokens[e.type].forEach(r=>{let i=e[r].flat(1/0);n=n.concat(this.walkTokens(i,t))}):e.tokens&&(n=n.concat(this.walkTokens(e.tokens,t)))}}return n}use(...e){let t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(e=>{let n={...e};if(n.async=this.defaults.async||n.async||!1,e.extensions&&(e.extensions.forEach(e=>{if(!e.name)throw Error(`extension name required`);if(`renderer`in e){let n=t.renderers[e.name];n?t.renderers[e.name]=function(...t){let r=e.renderer.apply(this,t);return r===!1&&(r=n.apply(this,t)),r}:t.renderers[e.name]=e.renderer}if(`tokenizer`in e){if(!e.level||e.level!==`block`&&e.level!==`inline`)throw Error(`extension level must be 'block' or 'inline'`);let n=t[e.level];n?n.unshift(e.tokenizer):t[e.level]=[e.tokenizer],e.start&&(e.level===`block`?t.startBlock?t.startBlock.push(e.start):t.startBlock=[e.start]:e.level===`inline`&&(t.startInline?t.startInline.push(e.start):t.startInline=[e.start]))}`childTokens`in e&&e.childTokens&&(t.childTokens[e.name]=e.childTokens)}),n.extensions=t),e.renderer){let t=this.defaults.renderer||new En(this.defaults);for(let n in e.renderer){if(!(n in t))throw Error(`renderer '${n}' does not exist`);if([`options`,`parser`].includes(n))continue;let r=n,i=e.renderer[r],a=t[r];t[r]=(...e)=>{let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n||``}}n.renderer=t}if(e.tokenizer){let t=this.defaults.tokenizer||new Tn(this.defaults);for(let n in e.tokenizer){if(!(n in t))throw Error(`tokenizer '${n}' does not exist`);if([`options`,`rules`,`lexer`].includes(n))continue;let r=n,i=e.tokenizer[r],a=t[r];t[r]=(...e)=>{let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n}}n.tokenizer=t}if(e.hooks){let t=this.defaults.hooks||new On;for(let n in e.hooks){if(!(n in t))throw Error(`hook '${n}' does not exist`);if([`options`,`block`].includes(n))continue;let r=n,i=e.hooks[r],a=t[r];On.passThroughHooks.has(n)?t[r]=e=>{if(this.defaults.async&&On.passThroughHooksRespectAsync.has(n))return(async()=>{let n=await i.call(t,e);return a.call(t,n)})();let r=i.call(t,e);return a.call(t,r)}:t[r]=(...e)=>{if(this.defaults.async)return(async()=>{let n=await i.apply(t,e);return n===!1&&(n=await a.apply(t,e)),n})();let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n}}n.hooks=t}if(e.walkTokens){let t=this.defaults.walkTokens,r=e.walkTokens;n.walkTokens=function(e){let n=[];return n.push(r.call(this,e)),t&&(n=n.concat(t.call(this,e))),n}}this.defaults={...this.defaults,...n}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return Z.lex(e,t??this.defaults)}parser(e,t){return Q.parse(e,t??this.defaults)}parseMarkdown(e){return(t,n)=>{let r={...n},i={...this.defaults,...r},a=this.onError(!!i.silent,!!i.async);if(this.defaults.async===!0&&r.async===!1)return a(Error(`marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise.`));if(typeof t>`u`||t===null)return a(Error(`marked(): input parameter is undefined or null`));if(typeof t!=`string`)return a(Error(`marked(): input parameter is of type `+Object.prototype.toString.call(t)+`, string expected`));if(i.hooks&&(i.hooks.options=i,i.hooks.block=e),i.async)return(async()=>{let n=i.hooks?await i.hooks.preprocess(t):t,r=await(i.hooks?await i.hooks.provideLexer(e):e?Z.lex:Z.lexInline)(n,i),a=i.hooks?await i.hooks.processAllTokens(r):r;i.walkTokens&&await Promise.all(this.walkTokens(a,i.walkTokens));let o=await(i.hooks?await i.hooks.provideParser(e):e?Q.parse:Q.parseInline)(a,i);return i.hooks?await i.hooks.postprocess(o):o})().catch(a);try{i.hooks&&(t=i.hooks.preprocess(t));let n=(i.hooks?i.hooks.provideLexer(e):e?Z.lex:Z.lexInline)(t,i);i.hooks&&(n=i.hooks.processAllTokens(n)),i.walkTokens&&this.walkTokens(n,i.walkTokens);let r=(i.hooks?i.hooks.provideParser(e):e?Q.parse:Q.parseInline)(n,i);return i.hooks&&(r=i.hooks.postprocess(r)),r}catch(e){return a(e)}}}onError(e,t){return n=>{if(n.message+=`
Please report this to https://github.com/markedjs/marked.`,e){let e=`<p>An error occurred:</p><pre>`+Y(n.message+``,!0)+`</pre>`;return t?Promise.resolve(e):e}if(t)return Promise.reject(n);throw n}}},An=new kn;function $(e,t){return An.parse(e,t)}$.options=$.setOptions=function(e){return An.setOptions(e),$.defaults=An.defaults,M($.defaults),$},$.getDefaults=A,$.defaults=j,$.use=function(...e){return An.use(...e),$.defaults=An.defaults,M($.defaults),$},$.walkTokens=function(e,t){return An.walkTokens(e,t)},$.parseInline=An.parseInline,$.Parser=Q,$.parser=Q.parse,$.Renderer=En,$.TextRenderer=Dn,$.Lexer=Z,$.lexer=Z.lex,$.Tokenizer=Tn,$.Hooks=On,$.parse=$,$.options,$.setOptions,$.use,$.walkTokens,$.parseInline,Q.parse,Z.lex;var jn=!1;function Mn(){jn||=(vt.addHook(`uponSanitizeAttribute`,(e,t)=>{t.attrName===`id`&&/^H[1-6]$/.test(e.tagName)&&(t.forceKeepAttr=!0)}),!0)}function Nn(e){Mn();let t=new Map,n=new kn;n.use({gfm:!0,breaks:!1,renderer:{heading(e){let n=this.parser.parseInline(e.tokens),r=ae(e.text,t);return`<h${e.depth} id="${r}">${n}</h${e.depth}>\n`}}});let r=n.parse(e,{async:!1});return vt.sanitize(r,{USE_PROFILES:{html:!0},ADD_ATTR:[`target`,`rel`]})}function Pn(e){let t=oe(e.markdown),n=Nn(e.markdown),r=h({view:`list`,query:``,category:`all`}),i=e.date?`<time datetime="${g(e.date)}">${g(e.date)}</time>`:``,a=e.tags.map(e=>`<span class="tag tag--soft">${g(e)}</span>`).join(``),o=e.status?`<span class="tag">${g(e.status)}</span>`:``,s=e.audience?`<p class="report__audience">想定読者: ${g(e.audience)}</p>`:``;return`
    <article class="report">
      ...
      <div class="report__main">
        <header class="report__header">
          ...
          <h1 class="report__title">${g(e.title)}</h1>
          <p class="report-card__summary">${g(e.summary)}</p>
          ${s}
          <div class="report-card__tags">${a}</div>
          <p class="report-card__path"><code>${g(e.path)}</code></p>
        </header>
  ...
  `}function Fn(e){return e.length?`<ul>${e.map(e=>`<li class="toc__item toc__item--h${e.level}"><button type="button" class="toc__link" data-target="${g(e.id)}">${g(e.text)}</button></li>`).join(``)}</ul>`:`<p class="toc__empty">見出しがありません</p>`}function In(e){let t=()=>{let t=re(location.hash);e.innerHTML=Ln(t),Rn(e,t)};window.addEventListener(`hashchange`,t),location.hash?t():location.hash=h({view:`list`,query:``,category:`all`})}function Ln(e){return`
    <div class="app-shell">
      <header class="top">
      ...
      ${e.view===`list`?ie({reports:te(ne,e.query,e.category),query:e.query,category:e.category,categories:p(ne),totalCount:ne.length}):(()=>{let t=m(ne,e.id);return t?Pn(t):`
              <section class="missing">
                <p>レポートが見つかりません: <code>${e.id}</code></p>
                <a href="${h({view:`list`,query:``,category:`all`})}">一覧へ戻る</a>
              </section>`})()}
    </div>
  `}function Rn(e,t){if(t.view===`report`){e.querySelectorAll(`.toc__link[data-target]`).forEach(t=>{t.addEventListener(`click`,()=>{let n=t.dataset.target;n&&e.querySelector(`#${CSS.escape(n)}`)?.scrollIntoView({behavior:`smooth`,block:`start`})})});return}let n=e.querySelector(`#report-search`);n?.addEventListener(`input`,()=>{let r={view:`list`,query:n.value,category:t.category},i=h(r);if(location.hash!==i){history.replaceState(null,``,i),e.innerHTML=Ln(r),Rn(e,r);let t=e.querySelector(`#report-search`);if(t){t.focus();let e=t.value.length;t.setSelectionRange(e,e)}}}),e.querySelectorAll(`[data-category]`).forEach(e=>{e.addEventListener(`click`,()=>{let n=e.dataset.category;location.hash=h({view:`list`,query:t.query,category:n})})})}var zn=document.querySelector(`#app`);zn&&In(zn);